...
O objetivo deste projeto era desenvolver uma API de um CRUD (Create, Read, Update e Delete) de palestrantes. Para tanto, foi utilizado endpoints para ler e escrever em um arquivo, (módulo `fs` do `Node`).

Foi muito importante para entender com maior clareza o que é o HTTP, o que é uma API e o que os dois têm a ver com o Express. Assim fui capaz de escrever meus próprios scripts que criam e consomem Promises;
...
1. Clone o repositório
  * `git clone https://github.com/andredebem/talker-manager.git`
...
4. Consulte as rotas e os verbos HTTP disponíveis nos arquivos **na pasta raiz do projeto** e faça as requisições de acordo
  * Via `Postman` ou `Insomnia`

OU

1. Acesse o mesmo link deste repositório com `1s` depois de `github` e antes de `.com`
  * `https://github1s.com/andredebem/talker-manager`

2. Agora você pode abrir os arquivos presentes **na pasta raiz do projeto** e consultar as rotas e os verbos HTTP disponíveis:
  * `index.js, loginRouter.js, talkerRouter.js`
...
1. Com exceção do requisito 3, todos os outros requisitos utilizaram o módulo `fs`.
